-- =====================================================
-- FIX: Corregir cálculo de actividades en leaderboard
-- Solo considerar actividades desbloqueadas (unlock_date <= today)
-- =====================================================

-- Actualizar la función get_leaderboard_data para filtrar actividades desbloqueadas
