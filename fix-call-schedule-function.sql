-- =====================================================
-- FIX: Actualizar función create_call_schedule
-- =====================================================

-- Eliminar todas las versiones existentes de la función
DROP FUNCTION IF EXISTS create_call_schedule(UUID, UUID, TIME, TIME, TIME);
DROP FUNCTION IF EXISTS create_call_schedule(UUID, UUID, TIME, TIME, TIME, TEXT);
DROP FUNCTION IF EXISTS create_call_schedule;
...
-- Otorgar permisos
GRANT EXECUTE ON FUNCTION create_call_schedule(UUID, UUID, TIME, TIME, TIME) TO authenticated;
